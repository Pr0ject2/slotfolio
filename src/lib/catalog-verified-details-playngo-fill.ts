...
import { getCatalogVerifiedDetailsPlayngoPassportCloseout9 } from "./catalog-verified-details-playngo-passport-closeout-9";
...
export function getCatalogVerifiedDetailsPlayngoFill(slug: string) {
  ...
  const closeout9 = getCatalogVerifiedDetailsPlayngoPassportCloseout9(slug);
  if (!legacy && !closeout1 && !closeout2 && !closeout3 && !closeout4 && !closeout5 && !closeout6 && !closeout7 && !closeout8 && !closeout9) return undefined;
  return { ...closeout9, ...closeout8, ...closeout7, ...closeout6, ...closeout5, ...closeout4, ...closeout3, ...closeout2, ...closeout1, ...legacy };
}
