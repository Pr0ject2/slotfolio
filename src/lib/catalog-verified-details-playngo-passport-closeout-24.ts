...
import { getCatalogVerifiedDetailsPlayngoPassportCloseout25 } from "./catalog-verified-details-playngo-passport-closeout-25";
...
export function getCatalogVerifiedDetailsPlayngoPassportCloseout24(slug: string) {
  return details[slug] ?? getCatalogVerifiedDetailsPlayngoPassportCloseout25(slug);
}
