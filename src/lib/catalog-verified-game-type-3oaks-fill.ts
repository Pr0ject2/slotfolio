...
export function getVerifiedCatalogGameType3OaksFill(slug: string): CatalogVerifiedGameType | undefined {
  return getVerifiedCatalogGameType3OaksCurrent(slug) ?? getVerifiedCatalogGameType3OaksScore6(slug) ?? getVerifiedCatalogGameType3OaksScore5(slug) ?? getVerifiedCatalogGameType3OaksFillLegacy(slug);
}
