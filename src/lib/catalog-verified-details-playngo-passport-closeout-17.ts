...
import { getCatalogVerifiedDetailsPlayngoPassportCloseout18 } from "./catalog-verified-details-playngo-passport-closeout-18";
...
export function getCatalogVerifiedDetailsPlayngoPassportCloseout17(slug: string) {
  return details[slug] ?? getCatalogVerifiedDetailsPlayngoPassportCloseout18(slug);
}
