...
const records: Record<string, CatalogVerifiedGameType> = {
  ...
  "bgaming-bonanza-billion-merge-uptm": { gameType: "Slots", source: "https://bgaming.com/games/bonanza-billion-merge-up", verifiedAt: verifiedAtCurrent },
  "bgaming-book-of-hidden-tombs": { gameType: "Slots", source: "https://bgaming.com/games/book-of-hidden-tombs", verifiedAt },
  "bgaming-cats-love-yummy": { gameType: "Slots", source: "https://bgaming.com/games/cats-love-yummy", verifiedAt: verifiedAtCurrent },
  ...
  "bgaming-multi-rush": { gameType: "Slots", source: "https://bgaming.com/games/multi-rush", verifiedAt: verifiedAtCurrent },
  "bgaming-mystic-reels": { gameType: "Slots", source: "https://bgaming.com/games/mystic-reels", verifiedAt: verifiedAtCurrent },
  ...
  "bgaming-train-heist-johnny-cash": { gameType: "Slots", source: "https://bgaming.com/games/train-heist-johnny-cash", verifiedAt: verifiedAtCurrent },
