...
import { getCatalogVerifiedDetailsPlayngoPassportCloseout11 } from "./catalog-verified-details-playngo-passport-closeout-11";
...
export function getCatalogVerifiedDetailsPlayngoPassportCloseout10(slug: string) {
  return details[slug] ?? getCatalogVerifiedDetailsPlayngoPassportCloseout11(slug);
}
