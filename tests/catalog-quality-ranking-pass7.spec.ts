...
test.only("rank thinnest runtime catalog-only records after quality pass 6", () => {
  ...
  console.log("CATALOG_QUALITY_DISTRIBUTION_PASS7", JSON.stringify(scoreDistribution));
  console.log("CATALOG_QUALITY_BOTTOM_PASS7", JSON.stringify(ranked.slice(0, 80)));
