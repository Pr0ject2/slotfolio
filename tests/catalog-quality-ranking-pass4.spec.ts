...
test.only("rank thinnest runtime catalog-only records after quality pass 3", () => {
  ...
  console.log("CATALOG_QUALITY_DISTRIBUTION_PASS4", JSON.stringify(scoreDistribution));
  console.log("CATALOG_QUALITY_BOTTOM_PASS4", JSON.stringify(ranked.slice(0, 140)));
