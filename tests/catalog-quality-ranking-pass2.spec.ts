...
test.only("rank thinnest runtime catalog-only records after quality pass 1", () => {
  ...
  console.log("CATALOG_QUALITY_DISTRIBUTION_PASS2", JSON.stringify(scoreDistribution));
  console.log("CATALOG_QUALITY_BOTTOM_PASS2", JSON.stringify(ranked.slice(0, 80)));
