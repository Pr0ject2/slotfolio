...
const researchTargets = {
  "playn-go-hope-unleashed-fortune-rises": "2026-03-24",
  "playn-go-legacy-of-inca": "2023-02-02",
  "playn-go-manta-mayhem": "2026-05-14",
  "playn-go-merlin-and-the-ice-queen-morgana": "2021-11-25",
  "playn-go-merry-xmas": "2014-11-17",
} as const;
...
test("second provider-wide Play’n GO batch preserves its eleven original official facts", () => {
  ...
  for (const [slug, releaseDate] of Object.entries(researchTargets)) {
    const seed = selected.get(slug)!;
    const details = getVerifiedCatalogDetails(slug);
    expect(details?.source, slug).toBe(seed.source);
