...
test.only("profile Push Gaming RTP maxWin volatility residual", () => {
  ...
  console.log("PUSH_STRUCTURED_PATTERNS", JSON.stringify(patterns));
  console.log("PUSH_STRUCTURED_RESIDUAL", JSON.stringify(rows));
