...
test.only("rank thinnest runtime catalog-only records after quality pass 5", () => {
  ...
  console.log("CATALOG_QUALITY_DISTRIBUTION_PASS6", JSON.stringify(scoreDistribution));
  console.log("CATALOG_QUALITY_BOTTOM_PASS6", JSON.stringify(ranked.slice(0, 100)));
