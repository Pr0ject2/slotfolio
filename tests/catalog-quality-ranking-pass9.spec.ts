...
test.only("rank thinnest runtime catalog-only records after quality pass 8", () => {
  ...
  console.log("CATALOG_QUALITY_DISTRIBUTION_PASS9", JSON.stringify(scoreDistribution));
  console.log("CATALOG_QUALITY_BOTTOM_PASS9", JSON.stringify(ranked.slice(0, 60)));
